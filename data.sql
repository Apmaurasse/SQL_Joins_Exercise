-- Part One, Question 1: SELECT * FROM vehicles v FULL OUTER JOIN owners o ON o.id=v.owner_id;

-- Part One, Question 2: SELECT o.first_name, o.last_name, COUNT(v.owner_id) FROM owners o JOIN vehicles v ON o.id = v.owner_id GROUP BY o.first_name, o.last_name ORDER BY o.first_name;

-- Part One, Question 3: SELECT o.first_name, o.last_name, ROUND(AVG(v.price)) as average_price, COUNT(v.owner_id) FROM owners o JOIN vehicles v ON o.id = v.owner_id GROUP BY o.first_name, o.last_name HAVING COUNT(v.owner_id) > 1 AND ROUND(AVG(v.price)) > 10000 ORDER BY o.first_name DESC;
